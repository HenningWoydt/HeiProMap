...
rm -rf extern/KaHIP/build-debug extern/local/kahip-debug
mkdir -p extern/KaHIP/build-debug
cd extern/KaHIP/build-debug

cmake .. \
  -DCMAKE_BUILD_TYPE=Debug \
  -DCMAKE_INSTALL_PREFIX="$PWD/../../../extern/local/kahip-debug" \
  -DNOMPI=ON \
  -DCMAKE_POSITION_INDEPENDENT_CODE=ON \
