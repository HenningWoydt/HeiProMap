#ifndef HEIDELBERGPROCESSMAPPING_PARALLEL_DISTANCE_ORACLE_H
#define HEIDELBERGPROCESSMAPPING_PARALLEL_DISTANCE_ORACLE_H
...
#endif //HEIDELBERGPROCESSMAPPING_PARALLEL_DISTANCE_ORACLE_H
