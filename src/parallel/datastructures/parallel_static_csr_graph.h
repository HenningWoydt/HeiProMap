#ifndef HEIDELBERGPROCESSMAPPING_PARALLEL_STATIC_CSR_GRAPH_H
#define HEIDELBERGPROCESSMAPPING_PARALLEL_STATIC_CSR_GRAPH_H
...
#endif //HEIDELBERGPROCESSMAPPING_PARALLEL_STATIC_CSR_GRAPH_H
