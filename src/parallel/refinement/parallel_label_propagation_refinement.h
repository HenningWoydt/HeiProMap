#ifndef HEIDELBERGPROCESSMAPPING_PARALLEL_LABEL_PROPAGATION_REFINEMENT_H
#define HEIDELBERGPROCESSMAPPING_PARALLEL_LABEL_PROPAGATION_REFINEMENT_H
...
#endif //HEIDELBERGPROCESSMAPPING_PARALLEL_LABEL_PROPAGATION_REFINEMENT_H
