#ifndef HEIDELBERGPROCESSMAPPING_PARALLEL_KAFFPA_PARTITIONER_H
#define HEIDELBERGPROCESSMAPPING_PARALLEL_KAFFPA_PARTITIONER_H
...
#endif //HEIDELBERGPROCESSMAPPING_PARALLEL_KAFFPA_PARTITIONER_H
